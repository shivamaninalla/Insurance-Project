...
function EditEmployee({firstName,lastName, mobile,email,dob,show,setFirstName,setLastName, setMobileNumber,setEmail,setDob,setShow,editData}) {

    console.log("values are!!!!!!!!!!!!!!!!!!!!!!!",firstName,lastName,email,mobile,dob)
